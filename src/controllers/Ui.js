...
function dashboard() {
  ...
  const todosCreatedCard = homeCard(
    "Todos Created",
    getTodosCount(),
    "#1020FF"
  );
  const todosCompletedCard = homeCard(
    "Todos Completed",
    getCompletedTodosCount(),
    "#10FF10"
  );
  const projectsCreatedCard = homeCard(
    "Projects Created",
    getProjectsCount(),
    "#FFFFAA"
  );
  const todosDeletedCard = homeCard("Todos Deleted", deletedTodos, "#EE0542");
